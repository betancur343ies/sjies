...
@Component({
    selector: 'jhi-operador-my-suffix',
    templateUrl: './operador-my-suffix.component.html'
})
export class OperadorMySuffixComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.operadorService
            ...
            .subscribe(
                (res: HttpResponse<IOperadorMySuffix[]>) => this.paginateOperadors(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/operador-my-suffix'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: IOperadorMySuffix) {
        return item.id;
    }
    ...
    private paginateOperadors(data: IOperadorMySuffix[], headers: HttpHeaders) {
